...
export const defaultPublicSiteDraft: PublicSiteDraft = {
  ...
  configSteps: {
    ...
    step4: {
      ...
      checkoutSubtext: 'Siap bikin sesuatu yang spesial untuk {recipient}?',
...
function buildConfigSteps(raw: any): PublicSiteDraft['configSteps'] {
  ...
  return {
    ...
    step4: {
      ...
      orderSummaryEmoji: asString(s4?.orderSummaryEmoji, d.step4.orderSummaryEmoji),
      ...
      checkoutSubtext: asString(s4?.checkoutSubtext, d.step4.checkoutSubtext),
...
export function buildPublicSiteConfigPayload(draft: PublicSiteDraft) {
  ...
  const nextConfigSteps = {
    ...
    step4: {
      ...
      orderSummaryEmoji: draft.configSteps.step4.orderSummaryEmoji.trim(),
      ...
      checkoutSubtext: draft.configSteps.step4.checkoutSubtext.trim(),
